...
List<UnbordingContent> contents = [
  UnbordingContent(
    ...
    discription: "Find exclusive items curated just for you. Explore a wide range of products with ease!"
    
  ),
  UnbordingContent(
    title: 'Exclusive Discounts',
    image: 'assets/girl-announcing-shopping-super-sale.png',
    discription: "Access special discounts every day. Save big while shopping for what you love!"
